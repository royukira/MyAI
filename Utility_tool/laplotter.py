...
class LossAccPlotter(object):
    ...
    def __init__(self,
        ...
        Args:
            ...
            LearnType: LFA or table
        """
        assert show_loss_plot or show_acc_plot
        #assert save_to_filepath is not None or show_plot_window  TODO
        ...
        self.learntype = LearnType   # TODO: I have add a self.learntype for plotting different learning algorithm with different color
        ...
        self.linestyles = {
            "loss_train": "r-",
            "loss_train_LFA":"b-",     # Todo: I have add a color for linear FA algorithm
            "loss_train_table":"r-",  # Todo: I have add a color for tabular look-up table algorithm
            "loss_train_sma": "r-",
    ...
    def redraw(self):
        ...
        #self._redraw_main_lines()  TODO
        self._redraw_averages()
        self._redraw_regressions()

        # Add legends (below both chart)
        ncol = 1
        labels = ["$CHART train"] # TODO: I have delete "$CHART val."
        if self.show_averages:
            pass
            #  TODO: I have delete "$CHART val. (avg %d)" % (self.averages_period,)
        ...
        #if self.save_to_filepath is not None:  TODO
    ...
    def _redraw_main_lines(self):
        ...
        # TODO: I have add two colors type
        if self.learntype == "LFA":
            ls_loss_train = self.linestyles["loss_train_LFA"]
        elif self.learntype == "table":
            ls_loss_train = self.linestyles["loss_train_table"]
        else:
